...
namespace App3
{
    ...
    public class MainActivity : AppCompatActivity, ISensorEventListener
    {
        ...
        //readonly string [] x;
        private float[] accelData = null; // массив ускорений по 3-м осям в формате xyzxyz...
        //05.05
        private float[] giroscopeData = null;
       // private float[] magnitometrData;
        ...
        private TextView textView_Value_GiroX;
        private TextView textView_Value_GiroY;
        private TextView textView_Value_GiroZ;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
           ...
           /* textView_Value_GiroX = (TextView)FindViewById(Resource.Id.textView_Value_GiroX);
            textView_Value_GiroY = (TextView)FindViewById(Resource.Id.textView_Value_GiroY);
            textView_Value_GiroZ = (TextView)FindViewById(Resource.Id.textView_Value_GiroZ);
            */
        ...
        override protected void OnResume()
        {
           ...
           // msensorManager.RegisterListener(this,msensorManager.GetDefaultSensor(SensorType.Orientation),SensorDelay.Game);
        ...
        private void LoadNewSensorData(SensorEvent e)
        {
            ...
            //if (type == SensorType.GyroscopeUncalibrated || type == SensorType.Gyroscope)
           ...
           //     giroscopeData = null;
            ...
            //10.05  madgwick.Update(deg2rad(giroscopeData[0]), deg2rad(giroscopeData[1]), deg2rad(giroscopeData[2]), accelData[0], accelData[1], accelData[2]);
            ...
            /* 10.05 if (type == SensorType.MagneticField)
            {
        ...
        public void OnSensorChanged(SensorEvent e)
        {
            ...
            if ((xView == null) || (yView == null) || (zView == null) || (textView_Value_GiroX == null) || (textView_Value_GiroY == null) || (textView_Value_GiroY == null))
            {
                xView.Text = "0";
                yView.Text = "0";
                zView.Text = "0";
                textView_Value_GiroX.Text = "0";
                textView_Value_GiroY.Text = "0";
                textView_Value_GiroZ.Text = "0";
          ...
          //  }
           ...
           // if ((textView_Value_GiroX == null) || (textView_Value_GiroY == null) || (textView_Value_GiroY == null))
          //  {
                textView_Value_GiroX = (TextView)FindViewById(Resource.Id.textView_Value_GiroX);
                textView_Value_GiroY = (TextView)FindViewById(Resource.Id.textView_Value_GiroY);
                textView_Value_GiroZ = (TextView)FindViewById(Resource.Id.textView_Value_GiroZ);
           // }
            ...
            textView_Value_GiroX.Text = (giroscopeData[0]).ToString();// ЗДЕСЬ ВОЗНИКАЕТ ИСКЛЮЧЕНИЕ ПОТОМУ ЧТО НЕТ ДАННЫХ ГИРОСКОПА
                                                                      // ИЗ МЕТОДА  LoadNewSensorData, Т.К НЕ ЗАХОДИТ В МЕТОД IF TYPE==GIRO..!!!
            textView_Value_GiroY.Text = (giroscopeData[1]).ToString();
            textView_Value_GiroZ.Text = (giroscopeData[2]).ToString();
